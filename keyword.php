...
<div id="header">
<h1>
<a href="Index.php">JindalsList: Search results for '<?php
session_start(); 
echo $_GET['search']."'";
?>
</a>
...
<div id="content">
 <?php
         ...
         $queryitem = "SELECT items.item_type, items.item_name, items.item_desc, items.item_price, user.user_email FROM user, items WHERE user.user_id = items.user_id AND (items.item_name LIKE '%$_GET[search]%' OR items.item_desc LIKE '%$_GET[search]%') ORDER BY items.item_name";         
