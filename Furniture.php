...
<div id="header">
<h1>
<a href="Index.php">JindalsList: Furniture</a>
</h1>
</div>
...
<div id="content">
 <?php
         ...
         $queryitem = "SELECT items.item_type, items.item_name, items.item_desc, items.item_price, user.user_email FROM user, items WHERE user.user_id = items.user_id AND items.item_type = 'furniture' ORDER BY items.item_name";
