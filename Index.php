...
<div id="header">
<h1>
<a href="Index.php">Welcome to JindalsList, 
<!--Check to see if user session is created-->
<?php
session_start(); 
...
<div id="navigation">
 <nav>
         <ul><center>
            <!--Display user options if created, otherwise show login and join button-->
            <?php
            if(isset($_SESSION['user_name']))
            {
...
<div id="content">
 <?php
         ...
         $queryitem = "SELECT items.item_type, items.item_name, items.item_desc, items.item_price, user.user_email FROM user, items WHERE user.user_id = items.user_id ORDER BY items.item_name";         
      ...
      <?php
         ...
         {
            print("<tr>");
            //Create mailto: link pulling info from user and items tables
